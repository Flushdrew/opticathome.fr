...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OAHCoreBundle', ($this->targetDirs[2].'/Resources/OAHCoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OAHCoreBundle', ($this->targetDirs[3].'\\src\\OAH\\CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\OAH\\NewsBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\OAH\\DevisBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\OAH\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'OAH\\NewsBundle\\Entity');
        $c->addDriver($b, 'OAH\\DevisBundle\\Entity');
        $c->addDriver($b, 'OAH\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('OAHNewsBundle' => 'OAH\\NewsBundle\\Entity', 'OAHDevisBundle' => 'OAH\\DevisBundle\\Entity', 'OAHUserBundle' => 'OAH\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_53c216856a20f934af76c47936a6cd20494c12daaa7a448f897c6b1610c65b57');
    ...
    {
        return $this->services['easyadmin.form.type'] = new \JavierEguiluz\Bundle\EasyAdminBundle\Form\Type\EasyAdminFormType($this->get('easyadmin.configurator'), array('formats' => array('date' => 'd/m/Y', 'time' => 'H:i', 'datetime' => 'd/m/Y H:i:s'), 'design' => array('brand_color' => 'rgb(148,125,93)', 'theme' => 'default', 'color_scheme' => 'dark', 'form_theme' => array(0 => '@EasyAdmin/form/bootstrap_3_horizontal_layout.html.twig'), 'assets' => array('css' => array(), 'js' => array())), 'site_name' => '<span style="font-size: 150%"> Optic at home</span>', 'entities' => array('Article' => array('class' => 'OAH\\NewsBundle\\Entity\\Article', 'list' => array('fields' => array('image' => array('property' => 'image', 'type' => 'image', 'base_path' => 'http://localhost/opticathome.fr/web/app_dev.php/media/cache/resolve/thumbnail/uploads/img/', 'template' => NULL), 'titre' => array('property' => 'titre', 'template' => NULL), 'auteur' => array('property' => 'auteur', 'template' => NULL), 'contenu' => array('property' => 'contenu', 'template' => NULL), 'date' => array('property' => 'date', 'template' => NULL)), 'actions' => array('show' => array('name' => 'show', 'type' => 'method', 'label' => 'action.show', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => NULL), 'search' => array('name' => 'search', 'type' => 'method', 'label' => 'action.search', 'class' => '', 'icon' => NULL), 'new' => array('name' => 'new', 'type' => 'method', 'label' => 'action.new', 'class' => '', 'icon' => NULL), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'form' => array('fields' => array(0 => 'titre', 1 => 'auteur', 2 => array('property' => 'contenu', 'type' => 'ckeditor', 'fieldType' => 'ckeditor'), 3 => 'categories', 4 => array('property' => 'Image', 'type' => 'oah_newsbundle_image'))), 'label' => 'Article', 'name' => 'Article', 'new' => array('fields' => array('titre' => array('property' => 'titre'), 'auteur' => array('property' => 'auteur'), 'contenu' => array('property' => 'contenu', 'type' => 'ckeditor', 'fieldType' => 'ckeditor'), 'categories' => array('property' => 'categories'), 'Image' => array('property' => 'Image', 'type' => 'oah_newsbundle_image')), 'form_options' => array(), 'actions' => array('list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'edit' => array('fields' => array('titre' => array('property' => 'titre'), 'auteur' => array('property' => 'auteur'), 'contenu' => array('property' => 'contenu', 'type' => 'ckeditor', 'fieldType' => 'ckeditor'), 'categories' => array('property' => 'categories'), 'Image' => array('property' => 'Image', 'type' => 'oah_newsbundle_image')), 'form_options' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'search' => array('fields' => array()), 'show' => array('fields' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => 'edit'))), 'disabled_actions' => array(), 'templates' => array('layout' => '@EasyAdmin/default/layout.html.twig', 'edit' => '@EasyAdmin/default/edit.html.twig', 'list' => '@EasyAdmin/default/list.html.twig', 'new' => '@EasyAdmin/default/new.html.twig', 'show' => '@EasyAdmin/default/show.html.twig', 'form' => '@EasyAdmin/default/form.html.twig', 'flash_messages' => '@EasyAdmin/default/flash_messages.html.twig', 'paginator' => '@EasyAdmin/default/paginator.html.twig', 'field_array' => '@EasyAdmin/default/field_array.html.twig', 'field_association' => '@EasyAdmin/default/field_association.html.twig', 'field_bigint' => '@EasyAdmin/default/field_bigint.html.twig', 'field_boolean' => '@EasyAdmin/default/field_boolean.html.twig', 'field_date' => '@EasyAdmin/default/field_date.html.twig', 'field_datetime' => '@EasyAdmin/default/field_datetime.html.twig', 'field_datetimetz' => '@EasyAdmin/default/field_datetimetz.html.twig', 'field_decimal' => '@EasyAdmin/default/field_decimal.html.twig', 'field_float' => '@EasyAdmin/default/field_float.html.twig', 'field_guid' => '@EasyAdmin/default/field_guid.html.twig', 'field_id' => '@EasyAdmin/default/field_id.html.twig', 'field_image' => '@EasyAdmin/default/field_image.html.twig', 'field_json_array' => '@EasyAdmin/default/field_json_array.html.twig', 'field_integer' => '@EasyAdmin/default/field_integer.html.twig', 'field_object' => '@EasyAdmin/default/field_object.html.twig', 'field_raw' => '@EasyAdmin/default/field_raw.html.twig', 'field_simple_array' => '@EasyAdmin/default/field_simple_array.html.twig', 'field_smallint' => '@EasyAdmin/default/field_smallint.html.twig', 'field_string' => '@EasyAdmin/default/field_string.html.twig', 'field_text' => '@EasyAdmin/default/field_text.html.twig', 'field_time' => '@EasyAdmin/default/field_time.html.twig', 'field_toggle' => '@EasyAdmin/default/field_toggle.html.twig', 'label_empty' => '@EasyAdmin/default/label_empty.html.twig', 'label_inaccessible' => '@EasyAdmin/default/label_inaccessible.html.twig', 'label_null' => '@EasyAdmin/default/label_null.html.twig', 'label_undefined' => '@EasyAdmin/default/label_undefined.html.twig')), 'Categories' => array('class' => 'OAH\\NewsBundle\\Entity\\Categorie', 'label' => 'Categories', 'name' => 'Categories', 'edit' => array('fields' => array(), 'form_options' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'list' => array('fields' => array(), 'actions' => array('show' => array('name' => 'show', 'type' => 'method', 'label' => 'action.show', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => NULL), 'search' => array('name' => 'search', 'type' => 'method', 'label' => 'action.search', 'class' => '', 'icon' => NULL), 'new' => array('name' => 'new', 'type' => 'method', 'label' => 'action.new', 'class' => '', 'icon' => NULL), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'new' => array('fields' => array(), 'form_options' => array(), 'actions' => array('list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'search' => array('fields' => array()), 'show' => array('fields' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => 'edit'))), 'disabled_actions' => array(), 'templates' => array('layout' => '@EasyAdmin/default/layout.html.twig', 'edit' => '@EasyAdmin/default/edit.html.twig', 'list' => '@EasyAdmin/default/list.html.twig', 'new' => '@EasyAdmin/default/new.html.twig', 'show' => '@EasyAdmin/default/show.html.twig', 'form' => '@EasyAdmin/default/form.html.twig', 'flash_messages' => '@EasyAdmin/default/flash_messages.html.twig', 'paginator' => '@EasyAdmin/default/paginator.html.twig', 'field_array' => '@EasyAdmin/default/field_array.html.twig', 'field_association' => '@EasyAdmin/default/field_association.html.twig', 'field_bigint' => '@EasyAdmin/default/field_bigint.html.twig', 'field_boolean' => '@EasyAdmin/default/field_boolean.html.twig', 'field_date' => '@EasyAdmin/default/field_date.html.twig', 'field_datetime' => '@EasyAdmin/default/field_datetime.html.twig', 'field_datetimetz' => '@EasyAdmin/default/field_datetimetz.html.twig', 'field_decimal' => '@EasyAdmin/default/field_decimal.html.twig', 'field_float' => '@EasyAdmin/default/field_float.html.twig', 'field_guid' => '@EasyAdmin/default/field_guid.html.twig', 'field_id' => '@EasyAdmin/default/field_id.html.twig', 'field_image' => '@EasyAdmin/default/field_image.html.twig', 'field_json_array' => '@EasyAdmin/default/field_json_array.html.twig', 'field_integer' => '@EasyAdmin/default/field_integer.html.twig', 'field_object' => '@EasyAdmin/default/field_object.html.twig', 'field_raw' => '@EasyAdmin/default/field_raw.html.twig', 'field_simple_array' => '@EasyAdmin/default/field_simple_array.html.twig', 'field_smallint' => '@EasyAdmin/default/field_smallint.html.twig', 'field_string' => '@EasyAdmin/default/field_string.html.twig', 'field_text' => '@EasyAdmin/default/field_text.html.twig', 'field_time' => '@EasyAdmin/default/field_time.html.twig', 'field_toggle' => '@EasyAdmin/default/field_toggle.html.twig', 'label_empty' => '@EasyAdmin/default/label_empty.html.twig', 'label_inaccessible' => '@EasyAdmin/default/label_inaccessible.html.twig', 'label_null' => '@EasyAdmin/default/label_null.html.twig', 'label_undefined' => '@EasyAdmin/default/label_undefined.html.twig')), 'Devis' => array('class' => 'OAH\\DevisBundle\\Entity\\Devis', 'disabled_actions' => array(0 => 'new', 1 => 'edit'), 'label' => 'Devis', 'name' => 'Devis', 'edit' => array('fields' => array(), 'form_options' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'list' => array('fields' => array(), 'actions' => array('show' => array('name' => 'show', 'type' => 'method', 'label' => 'action.show', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => NULL), 'search' => array('name' => 'search', 'type' => 'method', 'label' => 'action.search', 'class' => '', 'icon' => NULL), 'new' => array('name' => 'new', 'type' => 'method', 'label' => 'action.new', 'class' => '', 'icon' => NULL), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'new' => array('fields' => array(), 'form_options' => array(), 'actions' => array('list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'search' => array('fields' => array()), 'show' => array('fields' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => 'edit'))), 'templates' => array('layout' => '@EasyAdmin/default/layout.html.twig', 'edit' => '@EasyAdmin/default/edit.html.twig', 'list' => '@EasyAdmin/default/list.html.twig', 'new' => '@EasyAdmin/default/new.html.twig', 'show' => '@EasyAdmin/default/show.html.twig', 'form' => '@EasyAdmin/default/form.html.twig', 'flash_messages' => '@EasyAdmin/default/flash_messages.html.twig', 'paginator' => '@EasyAdmin/default/paginator.html.twig', 'field_array' => '@EasyAdmin/default/field_array.html.twig', 'field_association' => '@EasyAdmin/default/field_association.html.twig', 'field_bigint' => '@EasyAdmin/default/field_bigint.html.twig', 'field_boolean' => '@EasyAdmin/default/field_boolean.html.twig', 'field_date' => '@EasyAdmin/default/field_date.html.twig', 'field_datetime' => '@EasyAdmin/default/field_datetime.html.twig', 'field_datetimetz' => '@EasyAdmin/default/field_datetimetz.html.twig', 'field_decimal' => '@EasyAdmin/default/field_decimal.html.twig', 'field_float' => '@EasyAdmin/default/field_float.html.twig', 'field_guid' => '@EasyAdmin/default/field_guid.html.twig', 'field_id' => '@EasyAdmin/default/field_id.html.twig', 'field_image' => '@EasyAdmin/default/field_image.html.twig', 'field_json_array' => '@EasyAdmin/default/field_json_array.html.twig', 'field_integer' => '@EasyAdmin/default/field_integer.html.twig', 'field_object' => '@EasyAdmin/default/field_object.html.twig', 'field_raw' => '@EasyAdmin/default/field_raw.html.twig', 'field_simple_array' => '@EasyAdmin/default/field_simple_array.html.twig', 'field_smallint' => '@EasyAdmin/default/field_smallint.html.twig', 'field_string' => '@EasyAdmin/default/field_string.html.twig', 'field_text' => '@EasyAdmin/default/field_text.html.twig', 'field_time' => '@EasyAdmin/default/field_time.html.twig', 'field_toggle' => '@EasyAdmin/default/field_toggle.html.twig', 'label_empty' => '@EasyAdmin/default/label_empty.html.twig', 'label_inaccessible' => '@EasyAdmin/default/label_inaccessible.html.twig', 'label_null' => '@EasyAdmin/default/label_null.html.twig', 'label_undefined' => '@EasyAdmin/default/label_undefined.html.twig')), 'Utilisateurs' => array('class' => 'OAH\\UserBundle\\Entity\\User', 'list' => array('fields' => array('Username' => array('property' => 'Username', 'template' => NULL), 'Email' => array('property' => 'Email', 'template' => NULL)), 'actions' => array('show' => array('name' => 'show', 'type' => 'method', 'label' => 'action.show', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => NULL), 'search' => array('name' => 'search', 'type' => 'method', 'label' => 'action.search', 'class' => '', 'icon' => NULL), 'new' => array('name' => 'new', 'type' => 'method', 'label' => 'action.new', 'class' => '', 'icon' => NULL), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'disabled_actions' => array(0 => 'edit', 1 => 'show'), 'label' => 'Utilisateurs', 'name' => 'Utilisateurs', 'edit' => array('fields' => array(), 'form_options' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'new' => array('fields' => array(), 'form_options' => array(), 'actions' => array('list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'search' => array('fields' => array()), 'show' => array('fields' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => 'edit'))), 'templates' => array('layout' => '@EasyAdmin/default/layout.html.twig', 'edit' => '@EasyAdmin/default/edit.html.twig', 'list' => '@EasyAdmin/default/list.html.twig', 'new' => '@EasyAdmin/default/new.html.twig', 'show' => '@EasyAdmin/default/show.html.twig', 'form' => '@EasyAdmin/default/form.html.twig', 'flash_messages' => '@EasyAdmin/default/flash_messages.html.twig', 'paginator' => '@EasyAdmin/default/paginator.html.twig', 'field_array' => '@EasyAdmin/default/field_array.html.twig', 'field_association' => '@EasyAdmin/default/field_association.html.twig', 'field_bigint' => '@EasyAdmin/default/field_bigint.html.twig', 'field_boolean' => '@EasyAdmin/default/field_boolean.html.twig', 'field_date' => '@EasyAdmin/default/field_date.html.twig', 'field_datetime' => '@EasyAdmin/default/field_datetime.html.twig', 'field_datetimetz' => '@EasyAdmin/default/field_datetimetz.html.twig', 'field_decimal' => '@EasyAdmin/default/field_decimal.html.twig', 'field_float' => '@EasyAdmin/default/field_float.html.twig', 'field_guid' => '@EasyAdmin/default/field_guid.html.twig', 'field_id' => '@EasyAdmin/default/field_id.html.twig', 'field_image' => '@EasyAdmin/default/field_image.html.twig', 'field_json_array' => '@EasyAdmin/default/field_json_array.html.twig', 'field_integer' => '@EasyAdmin/default/field_integer.html.twig', 'field_object' => '@EasyAdmin/default/field_object.html.twig', 'field_raw' => '@EasyAdmin/default/field_raw.html.twig', 'field_simple_array' => '@EasyAdmin/default/field_simple_array.html.twig', 'field_smallint' => '@EasyAdmin/default/field_smallint.html.twig', 'field_string' => '@EasyAdmin/default/field_string.html.twig', 'field_text' => '@EasyAdmin/default/field_text.html.twig', 'field_time' => '@EasyAdmin/default/field_time.html.twig', 'field_toggle' => '@EasyAdmin/default/field_toggle.html.twig', 'label_empty' => '@EasyAdmin/default/label_empty.html.twig', 'label_inaccessible' => '@EasyAdmin/default/label_inaccessible.html.twig', 'label_null' => '@EasyAdmin/default/label_null.html.twig', 'label_undefined' => '@EasyAdmin/default/label_undefined.html.twig')), 'Newsletter' => array('class' => 'OAH\\DevisBundle\\Entity\\Newsletter', 'disabled_actions' => array(0 => 'new', 1 => 'edit'), 'label' => 'Newsletter', 'name' => 'Newsletter', 'edit' => array('fields' => array(), 'form_options' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'list' => array('fields' => array(), 'actions' => array('show' => array('name' => 'show', 'type' => 'method', 'label' => 'action.show', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => NULL), 'search' => array('name' => 'search', 'type' => 'method', 'label' => 'action.search', 'class' => '', 'icon' => NULL), 'new' => array('name' => 'new', 'type' => 'method', 'label' => 'action.new', 'class' => '', 'icon' => NULL), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'new' => array('fields' => array(), 'form_options' => array(), 'actions' => array('list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL))), 'search' => array('fields' => array()), 'show' => array('fields' => array(), 'actions' => array('delete' => array('name' => 'delete', 'type' => 'method', 'label' => 'action.delete', 'class' => '', 'icon' => 'trash'), 'list' => array('name' => 'list', 'type' => 'method', 'label' => 'action.list', 'class' => '', 'icon' => NULL), 'edit' => array('name' => 'edit', 'type' => 'method', 'label' => 'action.edit', 'class' => '', 'icon' => 'edit'))), 'templates' => array('layout' => '@EasyAdmin/default/layout.html.twig', 'edit' => '@EasyAdmin/default/edit.html.twig', 'list' => '@EasyAdmin/default/list.html.twig', 'new' => '@EasyAdmin/default/new.html.twig', 'show' => '@EasyAdmin/default/show.html.twig', 'form' => '@EasyAdmin/default/form.html.twig', 'flash_messages' => '@EasyAdmin/default/flash_messages.html.twig', 'paginator' => '@EasyAdmin/default/paginator.html.twig', 'field_array' => '@EasyAdmin/default/field_array.html.twig', 'field_association' => '@EasyAdmin/default/field_association.html.twig', 'field_bigint' => '@EasyAdmin/default/field_bigint.html.twig', 'field_boolean' => '@EasyAdmin/default/field_boolean.html.twig', 'field_date' => '@EasyAdmin/default/field_date.html.twig', 'field_datetime' => '@EasyAdmin/default/field_datetime.html.twig', 'field_datetimetz' => '@EasyAdmin/default/field_datetimetz.html.twig', 'field_decimal' => '@EasyAdmin/default/field_decimal.html.twig', 'field_float' => '@EasyAdmin/default/field_float.html.twig', 'field_guid' => '@EasyAdmin/default/field_guid.html.twig', 'field_id' => '@EasyAdmin/default/field_id.html.twig', 'field_image' => '@EasyAdmin/default/field_image.html.twig', 'field_json_array' => '@EasyAdmin/default/field_json_array.html.twig', 'field_integer' => '@EasyAdmin/default/field_integer.html.twig', 'field_object' => '@EasyAdmin/default/field_object.html.twig', 'field_raw' => '@EasyAdmin/default/field_raw.html.twig', 'field_simple_array' => '@EasyAdmin/default/field_simple_array.html.twig', 'field_smallint' => '@EasyAdmin/default/field_smallint.html.twig', 'field_string' => '@EasyAdmin/default/field_string.html.twig', 'field_text' => '@EasyAdmin/default/field_text.html.twig', 'field_time' => '@EasyAdmin/default/field_time.html.twig', 'field_toggle' => '@EasyAdmin/default/field_toggle.html.twig', 'label_empty' => '@EasyAdmin/default/label_empty.html.twig', 'label_inaccessible' => '@EasyAdmin/default/label_inaccessible.html.twig', 'label_null' => '@EasyAdmin/default/label_null.html.twig', 'label_undefined' => '@EasyAdmin/default/label_undefined.html.twig'))), 'disabled_actions' => array(), 'list' => array('actions' => array(), 'max_results' => 15), 'edit' => array('actions' => array()), 'new' => array('actions' => array()), 'show' => array('actions' => array()), 'default_entity_name' => 'Article'), new \Symfony\Component\Form\FormTypeGuesserChain(array(0 => $this->get('form.type_guesser.validator'), 1 => $this->get('form.type_guesser.doctrine'))));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('OAH\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OAH\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OAH\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('OAH\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'OAH\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'thumbnail' => array('filters' => array('thumbnail' => array('size' => array(0 => 300, 1 => 180), 'mode' => 'outbound')), 'quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'image_article_filter' => array('filters' => array('thumbnail' => array('size' => array(0 => 900, 1 => 540), 'mode' => 'outbound')), 'quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    /**
     * Gets the 'oah_news.ckeditor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OAH\NewsBundle\Form\Type\CkeditorType A OAH\NewsBundle\Form\Type\CkeditorType instance.
     */
    protected function getOahNews_CkeditorService()
    {
        return $this->services['oah_news.ckeditor'] = new \OAH\NewsBundle\Form\Type\CkeditorType();
    }

    /**
     * Gets the 'oah_news_antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OAH\NewsBundle\Antispam\OAHAntispam A OAH\NewsBundle\Antispam\OAHAntispam instance.
     */
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('OAH\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\OAH\\NewsBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'IvoryCKEditorBundle:Form:ckeditor_widget.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'LiipImagineBundle:Form:form_div_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'OAHCoreBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OAHUserBundle' => 'OAH\\UserBundle\\OAHUserBundle',
            ...
            'easyadmin.config' => array(
                ...
                'site_name' => '<span style="font-size: 150%"> Optic at home</span>',
                'entities' => array(
                    'Article' => array(
                        ...
                        'list' => array(
                            'fields' => array(
                                'image' => array(
                                    'property' => 'image',
                                    'type' => 'image',
                                    'base_path' => 'http://localhost/opticathome.fr/web/app_dev.php/media/cache/resolve/thumbnail/uploads/img/',
                                    'template' => NULL,
                                ),
                                'titre' => array(
                                    'property' => 'titre',
            ...
            'fos_user.model.user.class' => 'OAH\\UserBundle\\Entity\\User',
